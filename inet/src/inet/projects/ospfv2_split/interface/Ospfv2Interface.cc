...
#include "inet/projects/ospfv2_split/Ospfv2Crc.h"
#include "inet/projects/ospfv2_split/Ospfv2PacketSerializer.h"
...
void Ospfv2Interface::sendHelloPacket(Ipv4Address destination, short ttl)
{
    ...
    // ================= zhf add code to set area =================
    int area = int(this->getArea()->getRouter()->get_containing_module()->getParentModule()->par("area").intValue());
    helloPacket->setArea(area);
    // ================= zhf add code to set area =================
...
bool Ospfv2Interface::floodLsa(const Ospfv2Lsa *lsa, Ospfv2Interface *intf, Neighbor *neighbor)
{
    ...
    // zhf add code
    // -------------------------------------------------------------------------------------------------------------------------------------
    // int area_id = this->getArea()->getRouter()->get_containing_module()->getParentModule()->par("area_id").intValue();
    //    std::cout << "hello:" << this->getHelloInterval() << std::endl;
    //    std::cout << "router dead: " << this->getRouterDeadInterval() << std::endl;
    //    std::cout << "retransmission interval: " << this->retransmissionInterval << std::endl;
    // -------------------------------------------------------------------------------------------------------------------------------------
