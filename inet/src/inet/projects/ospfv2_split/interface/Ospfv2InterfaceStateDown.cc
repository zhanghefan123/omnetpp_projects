...
#include "inet/projects/ospfv2_split/interface/Ospfv2InterfaceStatePointToPoint.h"
#include "inet/projects/ospfv2_split/interface/Ospfv2InterfaceStateWaiting.h"
