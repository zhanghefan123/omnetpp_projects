...
#include "inet/projects/ospfv2_split/router/Ospfv2Common.h"
#include "inet/projects/ospfv2_split/router/Ospfv2RoutingTableEntry.h"
...
{
  private:
    cSimpleModule* containing_module = nullptr;  // zhf add code
