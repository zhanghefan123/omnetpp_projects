//
// Generated file, do not edit! Created by opp_msgtool 6.0 from inet/projects/ospfv2_new/Ospfv2Packet.msg.
//
...
Register_Enum(inet::ospfv2_new::Ospfv2TimerType, (inet::ospfv2_new::Ospfv2TimerType::INTERFACE_HELLO_TIMER, inet::ospfv2_new::Ospfv2TimerType::INTERFACE_WAIT_TIMER, inet::ospfv2_new::Ospfv2TimerType::INTERFACE_ACKNOWLEDGEMENT_TIMER, inet::ospfv2_new::Ospfv2TimerType::NEIGHBOR_INACTIVITY_TIMER, inet::ospfv2_new::Ospfv2TimerType::NEIGHBOR_POLL_TIMER, inet::ospfv2_new::Ospfv2TimerType::NEIGHBOR_DD_RETRANSMISSION_TIMER, inet::ospfv2_new::Ospfv2TimerType::NEIGHBOR_UPDATE_RETRANSMISSION_TIMER, inet::ospfv2_new::Ospfv2TimerType::NEIGHBOR_REQUEST_RETRANSMISSION_TIMER, inet::ospfv2_new::Ospfv2TimerType::DATABASE_AGE_TIMER));
...
Ospfv2OptionsDescriptor::Ospfv2OptionsDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2Options)), "")
{
...
Ospfv2PacketDescriptor::Ospfv2PacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2Packet)), "inet::ospf::OspfPacketBase")
{
    propertyNames = nullptr;
}
...
Ospfv2HelloPacket::Ospfv2HelloPacket() : ::inet::ospfv2_new::Ospfv2Packet()
{
    this->setType(HELLO_PACKET);

}

Ospfv2HelloPacket::Ospfv2HelloPacket(const Ospfv2HelloPacket& other) : ::inet::ospfv2_new::Ospfv2Packet(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::inet::ospfv2_new::Ospfv2Packet::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inet::ospfv2_new::Ospfv2Packet::parsimPack(b);
...
{
    ::inet::ospfv2_new::Ospfv2Packet::parsimUnpack(b);
...
Ospfv2HelloPacketDescriptor::Ospfv2HelloPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2HelloPacket)), "inet::ospfv2_new::Ospfv2Packet")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2HelloPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::ospfv2_new::Ospfv2Options",    // FIELD_options
...
Register_Enum(inet::ospfv2_new::Ospfv2LsaType, (inet::ospfv2_new::Ospfv2LsaType::ROUTERLSA_TYPE, inet::ospfv2_new::Ospfv2LsaType::NETWORKLSA_TYPE, inet::ospfv2_new::Ospfv2LsaType::SUMMARYLSA_NETWORKS_TYPE, inet::ospfv2_new::Ospfv2LsaType::SUMMARYLSA_ASBOUNDARYROUTERS_TYPE, inet::ospfv2_new::Ospfv2LsaType::AS_EXTERNAL_LSA_TYPE));
...
Ospfv2LsaHeaderDescriptor::Ospfv2LsaHeaderDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2LsaHeader)), "omnetpp::cObject")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2LsaHeaderDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::ospfv2_new::Ospfv2Options",    // FIELD_lsOptions
        "inet::ospfv2_new::Ospfv2LsaType",    // FIELD_lsType
...
const char *Ospfv2LsaHeaderDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    ...
    switch (field) {
        case FIELD_lsType:
            if (!strcmp(propertyName, "enum")) return "inet::ospfv2_new::Ospfv2LsaType";
            return nullptr;
        case FIELD_lsCrcMode:
...
std::string Ospfv2LsaHeaderDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_lsType: return enum2string(pp->getLsType(), "inet::ospfv2_new::Ospfv2LsaType");
...
void Ospfv2LsaHeaderDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_lsType: pp->setLsType((inet::ospfv2_new::Ospfv2LsaType)string2enum(value, "inet::ospfv2_new::Ospfv2LsaType")); break;
...
void Ospfv2LsaHeaderDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_lsType: pp->setLsType(static_cast<inet::ospfv2_new::Ospfv2LsaType>(value.intValue())); break;
...
Ospfv2LsaDescriptor::Ospfv2LsaDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2Lsa)), "omnetpp::cObject")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2LsaDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::ospfv2_new::Ospfv2LsaHeader",    // FIELD_header
    };
...
Register_Enum(inet::ospfv2_new::LinkType, (inet::ospfv2_new::LinkType::POINTTOPOINT_LINK, inet::ospfv2_new::LinkType::TRANSIT_LINK, inet::ospfv2_new::LinkType::STUB_LINK, inet::ospfv2_new::LinkType::VIRTUAL_LINK));
...
Ospfv2TosDataDescriptor::Ospfv2TosDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2TosData)), "")
{
    propertyNames = nullptr;
}
...
Ospfv2LinkDescriptor::Ospfv2LinkDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2Link)), "omnetpp::cObject")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2LinkDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::ospfv2_new::LinkType",    // FIELD_type
        "unsigned char",    // FIELD_numberOfTOS
        "unsigned long",    // FIELD_linkCost
        "inet::ospfv2_new::Ospfv2TosData",    // FIELD_tosData
    };
...
const char *Ospfv2LinkDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    ...
    switch (field) {
        case FIELD_type:
            if (!strcmp(propertyName, "enum")) return "inet::ospfv2_new::LinkType";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string Ospfv2LinkDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: return enum2string(pp->getType(), "inet::ospfv2_new::LinkType");
...
void Ospfv2LinkDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: pp->setType((inet::ospfv2_new::LinkType)string2enum(value, "inet::ospfv2_new::LinkType")); break;
...
void Ospfv2LinkDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_type: pp->setType(static_cast<inet::ospfv2_new::LinkType>(value.intValue())); break;
...
Ospfv2RouterLsa::Ospfv2RouterLsa() : ::inet::ospfv2_new::Ospfv2Lsa()
{
}

Ospfv2RouterLsa::Ospfv2RouterLsa(const Ospfv2RouterLsa& other) : ::inet::ospfv2_new::Ospfv2Lsa(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::inet::ospfv2_new::Ospfv2Lsa::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inet::ospfv2_new::Ospfv2Lsa::parsimPack(b);
...
{
    ::inet::ospfv2_new::Ospfv2Lsa::parsimUnpack(b);
...
Ospfv2RouterLsaDescriptor::Ospfv2RouterLsaDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2RouterLsa)), "inet::ospfv2_new::Ospfv2Lsa")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2RouterLsaDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::ospfv2_new::Ospfv2Link",    // FIELD_links
    };
...
Ospfv2NetworkLsa::Ospfv2NetworkLsa() : ::inet::ospfv2_new::Ospfv2Lsa()
{
}

Ospfv2NetworkLsa::Ospfv2NetworkLsa(const Ospfv2NetworkLsa& other) : ::inet::ospfv2_new::Ospfv2Lsa(other)
{
    copy(other);
}
...
Ospfv2NetworkLsaDescriptor::Ospfv2NetworkLsaDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2NetworkLsa)), "inet::ospfv2_new::Ospfv2Lsa")
{
    propertyNames = nullptr;
}
...
Ospfv2SummaryLsa::Ospfv2SummaryLsa() : ::inet::ospfv2_new::Ospfv2Lsa()
{
}

Ospfv2SummaryLsa::Ospfv2SummaryLsa(const Ospfv2SummaryLsa& other) : ::inet::ospfv2_new::Ospfv2Lsa(other)
{
    copy(other);
}
...
Ospfv2SummaryLsaDescriptor::Ospfv2SummaryLsaDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2SummaryLsa)), "inet::ospfv2_new::Ospfv2Lsa")
{
    propertyNames = nullptr;
}
...
Ospfv2ExternalTosInfoDescriptor::Ospfv2ExternalTosInfoDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2ExternalTosInfo)), "")
{
    propertyNames = nullptr;
}
...
Ospfv2AsExternalLsaContentsDescriptor::Ospfv2AsExternalLsaContentsDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2AsExternalLsaContents)), "omnetpp::cObject")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2AsExternalLsaContentsDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::Ipv4Address",    // FIELD_networkMask
        "inet::ospfv2_new::Ospfv2ExternalTosInfo",    // FIELD_externalTOSInfo
    };
    return (field >= 0 && field < 2) ? fieldTypeStrings[field] : nullptr;
}
...
Ospfv2AsExternalLsa::Ospfv2AsExternalLsa() : ::inet::ospfv2_new::Ospfv2Lsa()
{
}

Ospfv2AsExternalLsa::Ospfv2AsExternalLsa(const Ospfv2AsExternalLsa& other) : ::inet::ospfv2_new::Ospfv2Lsa(other)
{
    copy(other);
}
...
Ospfv2AsExternalLsaDescriptor::Ospfv2AsExternalLsaDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2AsExternalLsa)), "inet::ospfv2_new::Ospfv2Lsa")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2AsExternalLsaDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::ospfv2_new::Ospfv2AsExternalLsaContents",    // FIELD_contents
    };
    return (field >= 0 && field < 1) ? fieldTypeStrings[field] : nullptr;
}
...
Ospfv2DdOptionsDescriptor::Ospfv2DdOptionsDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2DdOptions)), "")
{
    propertyNames = nullptr;
}
...
Ospfv2DatabaseDescriptionPacket::Ospfv2DatabaseDescriptionPacket() : ::inet::ospfv2_new::Ospfv2Packet()
{
}

Ospfv2DatabaseDescriptionPacket::Ospfv2DatabaseDescriptionPacket(const Ospfv2DatabaseDescriptionPacket& other) : ::inet::ospfv2_new::Ospfv2Packet(other)
{
    copy(other);
}
...
Ospfv2DatabaseDescriptionPacketDescriptor::Ospfv2DatabaseDescriptionPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2DatabaseDescriptionPacket)), "inet::ospfv2_new::Ospfv2Packet")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2DatabaseDescriptionPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::ospfv2_new::Ospfv2Options",    // FIELD_options
        "inet::ospfv2_new::Ospfv2DdOptions",    // FIELD_ddOptions
        "unsigned long",    // FIELD_ddSequenceNumber
        "inet::ospfv2_new::Ospfv2LsaHeader",    // FIELD_lsaHeaders
    };
    return (field >= 0 && field < 5) ? fieldTypeStrings[field] : nullptr;
}
...
Ospfv2LsaRequestDescriptor::Ospfv2LsaRequestDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2LsaRequest)), "")
{
    propertyNames = nullptr;
}
...
Ospfv2LinkStateRequestPacket::Ospfv2LinkStateRequestPacket() : ::inet::ospfv2_new::Ospfv2Packet()
{
}

Ospfv2LinkStateRequestPacket::Ospfv2LinkStateRequestPacket(const Ospfv2LinkStateRequestPacket& other) : ::inet::ospfv2_new::Ospfv2Packet(other)
{
    copy(other);
}
...
Ospfv2LinkStateRequestPacketDescriptor::Ospfv2LinkStateRequestPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2LinkStateRequestPacket)), "inet::ospfv2_new::Ospfv2Packet")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2LinkStateRequestPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::ospfv2_new::Ospfv2LsaRequest",    // FIELD_requests
    };
    return (field >= 0 && field < 1) ? fieldTypeStrings[field] : nullptr;
}
...
Ospfv2LinkStateUpdatePacket::Ospfv2LinkStateUpdatePacket() : ::inet::ospfv2_new::Ospfv2Packet()
{
}

Ospfv2LinkStateUpdatePacket::Ospfv2LinkStateUpdatePacket(const Ospfv2LinkStateUpdatePacket& other) : ::inet::ospfv2_new::Ospfv2Packet(other)
{
    copy(other);
}
...
Ospfv2LinkStateUpdatePacketDescriptor::Ospfv2LinkStateUpdatePacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2LinkStateUpdatePacket)), "inet::ospfv2_new::Ospfv2Packet")
{
    propertyNames = nullptr;
}
...
const char *Ospfv2LinkStateUpdatePacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::ospfv2_new::Ospfv2Lsa",    // FIELD_ospfLSAs
    };
    return (field >= 0 && field < 1) ? fieldTypeStrings[field] : nullptr;
}
...
Ospfv2LinkStateAcknowledgementPacket::Ospfv2LinkStateAcknowledgementPacket() : ::inet::ospfv2_new::Ospfv2Packet()
{
}

Ospfv2LinkStateAcknowledgementPacket::Ospfv2LinkStateAcknowledgementPacket(const Ospfv2LinkStateAcknowledgementPacket& other) : ::inet::ospfv2_new::Ospfv2Packet(other)
{
    copy(other);
}
...
Ospfv2LinkStateAcknowledgementPacketDescriptor::Ospfv2LinkStateAcknowledgementPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::ospfv2_new::Ospfv2LinkStateAcknowledgementPacket)), "inet::ospfv2_new::Ospfv2Packet")
{
    propertyNames = nullptr;
}
