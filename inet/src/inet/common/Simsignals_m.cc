...
Register_Enum(inet::PacketDropReason, (inet::PacketDropReason::ADDRESS_RESOLUTION_FAILED, inet::PacketDropReason::FORWARDING_DISABLED, inet::PacketDropReason::HOP_LIMIT_REACHED, inet::PacketDropReason::INCORRECTLY_RECEIVED, inet::PacketDropReason::INTERFACE_DOWN, inet::PacketDropReason::NO_INTERFACE_FOUND, inet::PacketDropReason::NO_ROUTE_FOUND, inet::PacketDropReason::NOT_ADDRESSED_TO_US, inet::PacketDropReason::QUEUE_OVERFLOW, inet::PacketDropReason::RETRY_LIMIT_REACHED, inet::PacketDropReason::LIFETIME_EXPIRED, inet::PacketDropReason::CONGESTION, inet::PacketDropReason::NO_PROTOCOL_FOUND, inet::PacketDropReason::NO_PORT_FOUND, inet::PacketDropReason::DUPLICATE_DETECTED, inet::PacketDropReason::OTHER_PACKET_DROP));
