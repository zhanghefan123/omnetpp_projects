...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:24</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:29</tt> by opp_msgtool.
 * <pre>
...
class INET_API TimeTagBase : public ::inet::TagBase
{
  ...
  public:
    ...
    [[deprecated]] void insertTotalTimes(::omnetpp::simtime_t totalTimes) {appendTotalTimes(totalTimes);}
    virtual void appendTotalTimes(::omnetpp::simtime_t totalTimes);
    virtual void eraseTotalTimes(size_t k);


#if (OMNETPP_BUILDNUM < 1530)
  public:
    void appendFlowNames(const char *names) { insertFlowNames(names); }
    void appendTotalTimes(omnetpp::simtime_t totalTimes) { insertTotalTimes(totalTimes); }
#endif
};
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:43</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:51</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:55</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:59</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TimeTag.msg:63</tt> by opp_msgtool.
 * <pre>
