...
inline any_ptr toAnyPtr(const inet::tcp::TcpStateVariables *p) {return any_ptr(p);}
template<> inline inet::tcp::TcpStateVariables *fromAnyPtr(any_ptr ptr) { return ptr.get<inet::tcp::TcpStateVariables>(); }
