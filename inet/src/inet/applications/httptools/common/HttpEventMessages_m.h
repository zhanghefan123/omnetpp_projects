...
/**
 * Class generated from <tt>inet/applications/httptools/common/HttpEventMessages.msg:31</tt> by opp_msgtool.
 * <pre>
 * //
...
template<> inline inet::httptools::HttpServerStatusUpdateMsg *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::httptools::HttpServerStatusUpdateMsg*>(ptr.get<cObject>()); }
